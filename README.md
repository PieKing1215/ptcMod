...
Currently 0.9.2.5 is fully supported and 0.9.4.54 has some simple things but not the newer custom rendering stuff (0.9.4.56 is also unsupported -> https://github.com/PieKing1215/ptcMod/issues/22)
